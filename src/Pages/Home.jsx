  ...
  return (
    <div className="min-h-screen ">
      <div className=" mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 space-y-4 md:space-y-0 bg-[#111] p-4 text-white rounded-xl">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-white mt-1">Manage your book shop</p>
            </div>
          </div>
